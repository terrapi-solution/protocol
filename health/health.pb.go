...
const (
	...
	HealthCheck_SERVICE_UNKNOWN HealthCheck_ServingStatus = 3
	HealthCheck_INTERNAL_ERROR  HealthCheck_ServingStatus = 4
)
...
type HealthCheck struct {
	...
	Status HealthCheck_ServingStatus `protobuf:"varint,2,opt,name=status,proto3,enum=terrapi.v1.health.HealthCheck_ServingStatus" json:"status,omitempty"`
}
...
type HealthChecks struct {
	...
	Results []*HealthCheck `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
}
...
func (x *HealthChecks) GetResults() []*HealthCheck {
	if x != nil {
		return x.Results
	}
	return nil
...
var file_health_health_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x74, 0x65, 0x72, 0x72, 0x61, 0x70, 0x69, 0x2e, 0x76,
	0x31, 0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x22, 0x28, 0x0a, 0x0c, 0x43, 0x68, 0x65, 0x63,
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0xcc, 0x01,
	...
	0x0e, 0x32, 0x2c, 0x2e, 0x74, 0x65, 0x72, 0x72, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x68,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x63, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	,
...
var file_health_health_proto_goTypes = []any{
	(HealthCheck_ServingStatus)(0), // 0: terrapi.v1.health.HealthCheck.ServingStatus
	(*CheckRequest)(nil),           // 1: terrapi.v1.health.CheckRequest
	(*CheckAllRequest)(nil),        // 2: terrapi.v1.health.CheckAllRequest
	(*HealthCheck)(nil),            // 3: terrapi.v1.health.HealthCheck
	(*HealthChecks)(nil),           // 4: terrapi.v1.health.HealthChecks
}
var file_health_health_proto_depIdxs = []int32{
	0, // 0: terrapi.v1.health.HealthCheck.status:type_name -> terrapi.v1.health.HealthCheck.ServingStatus
	3, // 1: terrapi.v1.health.HealthChecks.results:type_name -> terrapi.v1.health.HealthCheck
	1, // 2: terrapi.v1.health.HealthService.Check:input_type -> terrapi.v1.health.CheckRequest
	2, // 3: terrapi.v1.health.HealthService.CheckAll:input_type -> terrapi.v1.health.CheckAllRequest
	3, // 4: terrapi.v1.health.HealthService.Check:output_type -> terrapi.v1.health.HealthCheck
	4, // 5: terrapi.v1.health.HealthService.CheckAll:output_type -> terrapi.v1.health.HealthChecks
