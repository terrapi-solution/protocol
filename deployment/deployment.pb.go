...
type SetStatusRequest struct {
	...
	Action       Action `protobuf:"varint,2,opt,name=action,proto3,enum=deployment.Action" json:"action,omitempty"`
}
...
type Request struct {
	...
	Action    Action             `protobuf:"varint,1,opt,name=action,proto3,enum=deployment.Action" json:"action,omitempty"`
...
type Status struct {
	...
	State     Status_State `protobuf:"varint,1,opt,name=state,proto3,enum=deployment.Status_State" json:"state,omitempty"`
...
var file_deployment_deployment_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x1c, 0x0a, 0x0a, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x63, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x53, 0x74,
	...
	0x32, 0x12, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x82, 0x01, 0x0a,
	...
	,
	...
	0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0xf0, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x2e, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x18, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e,
	...
	0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x7e, 0x0a, 0x05, 0x53,
	...
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x11,
	...
	,
...
var file_deployment_deployment_proto_goTypes = []any{
	(Action)(0),              // 0: deployment.Action
	(Status_State)(0),        // 1: deployment.Status.State
	(*GetRequest)(nil),       // 2: deployment.GetRequest
	(*SetStatusRequest)(nil), // 3: deployment.SetStatusRequest
	(*Module)(nil),           // 4: deployment.Module
	(*Request)(nil),          // 5: deployment.Request
	(*RequestVariable)(nil),  // 6: deployment.RequestVariable
	(*Status)(nil),           // 7: deployment.Status
	(*GetResponse)(nil),      // 8: deployment.GetResponse
}
var file_deployment_deployment_proto_depIdxs = []int32{
	0, // 0: deployment.SetStatusRequest.action:type_name -> deployment.Action
	0, // 1: deployment.Request.action:type_name -> deployment.Action
	6, // 2: deployment.Request.variables:type_name -> deployment.RequestVariable
	1, // 3: deployment.Status.state:type_name -> deployment.Status.State
	4, // 4: deployment.GetResponse.module:type_name -> deployment.Module
	5, // 5: deployment.GetResponse.request:type_name -> deployment.Request
	7, // 6: deployment.GetResponse.status:type_name -> deployment.Status
	2, // 7: deployment.DeploymentService.Get:input_type -> deployment.GetRequest
	3, // 8: deployment.DeploymentService.SetStatus:input_type -> deployment.SetStatusRequest
	8, // 9: deployment.DeploymentService.Get:output_type -> deployment.GetResponse
	8, // 10: deployment.DeploymentService.SetStatus:output_type -> deployment.GetResponse
